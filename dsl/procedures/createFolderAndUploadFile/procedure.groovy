...
def procName='createFolderAndUploadFile'
procedure procName, {
  ...
  step 'checkConfiguration',
    ...
    step 'createFolderAndUploadFile',
      command: new File(pluginDir, "dsl/procedures/$procName/steps/createFolderAndUploadFile.groovy").text,
      shell: 'ec-groovy'
